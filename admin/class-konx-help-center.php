...
class Konx_Help_Center {
	...
	public static function render_page() {
		...
		?>
		<div class="wrap">
			<h1><?php esc_html_e( 'Help Center', 'konx-affiliate-dashboard' ); ?></h1>
