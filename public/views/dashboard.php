...
<div class="konx-dashboard">
	...
	<button type="button" class="konx-portal-toggle" aria-expanded="false" aria-controls="konx-portal-nav" onclick="konxToggleNav()">
		<span class="konx-portal-toggle-label"><?php esc_html_e( 'Affiliate Portal Menu', 'konx-affiliate-dashboard' ); ?></span>
		<span class="konx-portal-toggle-icon" aria-hidden="true">&#9776;</span>
	</button>

	<!-- Portal Layout -->
	<div class="konx-portal">

		<!-- Sidebar Navigation -->
		<nav class="konx-portal-nav" id="konx-portal-nav" role="navigation" aria-label="<?php esc_attr_e( 'Affiliate Portal', 'konx-affiliate-dashboard' ); ?>">
			<ul class="konx-portal-menu">
				<li><a href="#overview" class="konx-portal-link active" data-section="overview"><?php esc_html_e( 'Overview', 'konx-affiliate-dashboard' ); ?></a></li>
				<li><a href="#referral-tools" class="konx-portal-link" data-section="referral-tools"><?php esc_html_e( 'Referral Tools', 'konx-affiliate-dashboard' ); ?></a></li>
				<li><a href="#financial-activity" class="konx-portal-link" data-section="financial-activity"><?php esc_html_e( 'Financial Activity', 'konx-affiliate-dashboard' ); ?></a></li>
				<li><a href="#achievements" class="konx-portal-link" data-section="achievements"><?php esc_html_e( 'Achievements', 'konx-affiliate-dashboard' ); ?></a></li>
				<li><a href="#commission-rates" class="konx-portal-link" data-section="commission-rates"><?php esc_html_e( 'Commission Rates', 'konx-affiliate-dashboard' ); ?></a></li>
				<li><a href="#profile-settings" class="konx-portal-link" data-section="profile-settings"><?php esc_html_e( 'Profile Settings', 'konx-affiliate-dashboard' ); ?></a></li>
			</ul>
		</nav>

		<!-- Main Content -->
		<div class="konx-portal-content">
			...
			<section id="overview" class="konx-portal-section">
				...
				<div class="konx-hero-cards">
					<div class="konx-hero-card konx-hero-card-primary">
						...
						<a href="#financial-activity" class="konx-btn konx-btn-sm konx-btn-outline konx-hero-card-action" onclick="konxActivateTab('withdrawals')">
...
(function(){
	...
	// === Portal Navigation — Active Section Highlighting ===
	var sections = document.querySelectorAll('.konx-portal-section');
	var navLinks = document.querySelectorAll('.konx-portal-link');
		...
		link.addEventListener('click', function(e){
			...
			if(href && href.charAt(0) === '#'){
				...
				if(target){
					...
					// Close mobile nav
					var nav = document.getElementById('konx-portal-nav');
					var toggle = document.querySelector('.konx-portal-toggle');
					if(nav && toggle && toggle.offsetParent !== null){
